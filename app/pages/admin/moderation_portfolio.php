...
$pageTitle = 'Portfolio Moderation';
$activeNav = 'moderation_portfolio';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!csrf_verify()) {
        ...
        if ($entityId <= 0) {
            $errors[] = 'Portfolio item ID is required.';
        }
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1 class="h3 mb-1">Portfolio Moderation</h1>
        <p class="text-muted mb-0">Control portfolio visibility across the platform.</p>
    </div>
</div>
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <form method="post">
                    <?= csrf_field(); ?>
                    <div class="mb-3">
                        <label class="form-label">Portfolio item ID</label>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="action_type" required>
                            <option value="hide">Hide portfolio item</option>
                            <option value="unhide">Unhide portfolio item</option>
                        </select>
                    </div>
                    <div class="mb-3">
            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    ...
                    <?php if (!$recentActions): ?>
                        <tr>
                            <td colspan="4" class="text-center text-muted py-4">No portfolio actions recorded.</td>
                        </tr>
                    <?php endif; ?>
                    </tbody>
                </table>
