...
if (!$variantRows) {
    $variantRows = array_fill(0, 3, ['name' => '', 'price' => '']);
}
                ...
                <div class="mt-4">
                    ...
                    <?php foreach ($variantRows as $index => $variant): ?>
                        <div class="row g-2 mb-2">
                            ...
                            <div class="col-md-4">
                                <input class="form-control" type="number" name="variant_price[]" min="0" step="0.01" placeholder="Price add" value="<?= htmlspecialchars((string) $variant['price'], ENT_QUOTES, 'UTF-8') ?>">
                            </div>
                        </div>
                    <?php endforeach; ?>
                </div>
                ...
                <div class="mt-4">
                    ...
                    <?php foreach ($addonRows as $addon): ?>
                        <div class="row g-2 mb-2">
                            ...
                            <div class="col-md-4">
                                <input class="form-control" type="number" name="addon_price[]" min="0" step="0.01" placeholder="Add-on price" value="<?= htmlspecialchars((string) $addon['price'], ENT_QUOTES, 'UTF-8') ?>">
                            </div>
                        </div>
                    <?php endforeach; ?>
                </div>
